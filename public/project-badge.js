(function () {
  const projectName = 'FinFlow B2B';
  const projectUrl = 'https://alxnrocha.github.io/financial-dashboard/';
  const description = 'Intelig̻ncia Financeira, DRE & Fluxo de Caixa';
